...
namespace InitDB {
    public class CommonValidator {
        ...
        {"steamed","fried", "slow roasted", "boiled", "fast roasted", "fast fried", "grilled", "pan-browned", "crumbles",
        ...
        {"sun-dried", "dried", "freeze-dried","unprepared","prepared", "ground", "pre-sliced", "frozen", "cooked", "canned", "heated", "unheated" };
