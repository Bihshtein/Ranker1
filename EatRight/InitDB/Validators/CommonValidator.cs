...
namespace InitDB {
    public class CommonValidator {
        public static List<string> WashingOptions = new List<string>() {
            "rinsed with tap water", "rinsed in tap water"
        };
        public static List<string> CookingOptions = new List<string>() 
        {"or baked", "oven heated","pan-fried in canola oil","pan fried in canola oil","candied","as purchased","oven-heated","sauteed", "breaded","stir-fried","steamed","fried", "slow roasted",
        ...
        {"frozen as packaged","freeze-dried","unprepared","prepared", "ground", "pre-sliced", "frozen", "cooked", "canned", "heated", "unheated" };
