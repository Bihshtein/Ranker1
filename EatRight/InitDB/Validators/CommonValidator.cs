...
namespace InitDB {
    public class CommonValidator {
        ...
        "concentrate","sucralose","sugar", "undiluted","calcium", "sulfured", "ascorbic acid","sodium", "milk","salt","water","butter","margarine","green chilies","onions","mushrooms","herbs and cheese","dill","artificial sweetener","sweetened","unsweetened"
        };
        ...
        private static List<string> PackOptions = new List<string>()
            {"extra heavy syrup", "heavy syrup", "extra light syrup","light syrup","drained", "puree","paste","sauce" , "in tomato juice","all styles", "regular", "brine", "vacuum",
        ...
        public static List<string> CookingOptions = new List<string>() 
            {"raw or frozen","uncooked","french fried","home-prepared","or baked", "oven heated","pan-fried in canola oil","pan fried in canola oil","candied","as purchased","oven-heated","sauteed", "breaded","stir-fried","steamed","fried", "slow roasted",
        ...
        {"chilled","riped","ripe", "bottled","dehydrated (low-moisture)","dehydrated (low moisture)","canned or bottled","frozen concentrate","rehydrated","dry","sprouted","dehydrated","seasoned","freshly harvest", "stored" ,"dry mix","dry form"
