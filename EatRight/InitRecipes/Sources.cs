    ...
    class Sources {
        ...
        public static Dictionary<RecipesSource, Dictionary<MealType, Tuple<string, string, int>>> MealTypesURNs = new Dictionary<RecipesSource, Dictionary<MealType, Tuple<string, string, int>>>() {
         /*     {RecipesSource.AllRecipes, new Dictionary<MealType, Tuple<string,string, int>>() {
                {MealType.Lunch, new Tuple<string,string,int>( "page","http://allrecipes.com/recipes/17561/lunch/",10) } ,
                {MealType.Breakfast, new Tuple<string,string,int>( "page","http://allrecipes.com/recipes/78/breakfast-and-brunch",10) } ,
                {MealType.Dinner, new Tuple<string,string,int>( "page","http://allrecipes.com/recipes/17562/dinner",10) }
              }
            },
               {RecipesSource.Food, new Dictionary<MealType, Tuple<string,string, int>>() {
                    ...
                    {MealType.Breakfast, new Tuple<string,string,int>( "pn","http://breakfast.food.com",10) } ,
                    {MealType.Lunch, new Tuple<string,string,int>( "pn","http://lunch.food.com",10) }
                }
            },*/
            {RecipesSource.Cookpad, new Dictionary<MealType, Tuple<string,string, int>>() {
                {MealType.Breakfast, new Tuple<string,string,int>("page","https://cookpad.com/us/search/breakfast",900)},
                {MealType.Lunch,  new Tuple<string,string,int>("page","https://cookpad.com/us/search/lunch",15000 )},
                {MealType.Dinner, new Tuple<string,string,int>( "page","https://cookpad.com/us/search/dinner" ,5000)} }
            },
