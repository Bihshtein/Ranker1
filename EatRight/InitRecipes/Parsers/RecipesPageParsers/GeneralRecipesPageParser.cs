...
{
    public class GeneralRecipesPageParser : IRecipesPageParser
    {
        public void AddRecipesFromPage(string pageStr, RestDBInterface unit)
        {
            ...
            string[] parts = pageStr.Split(new string[] { Sources.RecipesURNs[source].PageSplitterStr }, StringSplitOptions.None);
